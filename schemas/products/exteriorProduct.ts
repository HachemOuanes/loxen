...
export const exteriorProduct = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Product ID',
      type: 'string',
      description: 'Unique identifier for this product (e.g., PROD-001, EXT-2024-001)',
      validation: (Rule) => 
        Rule.required()
          .custom(async (value, context) => {
            ...
            const query = `*[_type == "exteriorProduct" && productId == $productId && !(_id in path("drafts.**")) && _id != $id]`
