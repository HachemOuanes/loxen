...
export function InteriorSection() {
  const categories = [
    { name: "Café / Hôtel / Restaurant", image: "/interior-cafe-hotel-restaurant.jpg" },
    { name: "Mobiliers", image: "/interior-mobiliers.jpg" },
    { name: "Salle de Bain", image: "/interior-salle-de-bain.jpg" },
    { name: "Écoles & Universités", image: "/interior-ecoles-universites.jpg" },
  ]
  ...
  return (
    <section id="interieur" className="relative min-h-screen flex flex-col lg:flex-row">
      <div className="w-full lg:w-1/3 relative flex flex-col items-center justify-center p-4 lg:my-4 lg:ml-4 z-10 min-h-[50vh] lg:min-h-0">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: "url('/interior-design-background.jpg')" }}
        />
        ...
        <div className="relative text-center space-y-4 sm:space-y-6 lg:space-y-8 px-4">
          ...
          <p className="text-white/80 font-light text-sm sm:text-base lg:text-lg leading-relaxed max-w-xs sm:max-w-sm">
            Solutions d'aménagement intérieur sur mesure alliant esthétique contemporaine et fonctionnalité optimale
            pour tous types d'espaces.
          </p>
          <Button
            onClick={scrollToTop}
      ...
      <div className="w-full lg:w-2/3 min-h-[50vh] lg:min-h-0">
