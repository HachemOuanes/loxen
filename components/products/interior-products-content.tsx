...
interface InteriorProductsContentProps {
  applications: Application[]
}

export function InteriorProductsContent({ applications: initialApplications }: InteriorProductsContentProps) {
    ...
    return (
      <section className="w-full min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center px-4">
          ...
          <p className="text-gray-500">Aucune application intérieure disponible pour le moment.</p>
        </div>
      </section>
    )
  }
  ...
  return (
    <section id="interieur" className="w-full relative z-10 m-0 p-0 bg-white min-h-screen overflow-hidden">
          ...
          <div className="pt-20 md:pt-24 pb-4 md:pb-6 pr-4 md:pr-6 relative z-30">
            <div className="mb-6 md:mb-8">
              <h3 className="text-black mb-3 tracking-[-0.02em] leading-tight flex flex-col">
                <i className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl">Applications</i>  <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Intérieures</span>
              </h3>
            </div>
